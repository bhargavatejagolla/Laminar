      ...
      <div className="bg-[#0f172a] border border-slate-700/60 rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-5 border-b border-slate-800">
          <h2 className="text-lg font-semibold text-white flex items-center gap-2">
            <Video className="w-5 h-5 text-cyan-400" /> Connect Video Source
          </h2>
        ...
        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700">
          <div className="space-y-1">
            <label className="text-xs uppercase tracking-widest text-slate-400 font-semibold">Node Name</label>
            <input 
              type="text" 
          ...
          {!venueId && (
            <div className="space-y-1">
              <label className="text-xs uppercase tracking-widest text-slate-400 font-semibold">Target Venue</label>
              <select 
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-xs uppercase tracking-widest text-slate-400 font-semibold">Stream Type</label>
              <select 
            ...
            <div className="space-y-1">
              <label className="text-xs uppercase tracking-widest text-slate-400 font-semibold">Target FPS</label>
              <input 
                type="number" 
                value={formData.fps}
                min="1"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-xs uppercase tracking-widest text-slate-400 font-semibold">Res Width</label>
              <input 
                type="number" 
            ...
            <div className="space-y-1">
              <label className="text-xs uppercase tracking-widest text-slate-400 font-semibold">Res Height</label>
              <input 
                type="number" 
          ...
          <div className="space-y-3 pt-2 bg-slate-800/20 p-4 rounded-lg border border-slate-800">
             <label className="flex items-center gap-3 cursor-pointer group">
                ...
                <span className="text-sm font-medium text-slate-300 group-hover:text-white transition-colors">Node Hardware Active</span>
             </label>
             <label className="flex items-center gap-3 cursor-pointer group">
          ...
          <div className="bg-emerald-500/10 border border-emerald-500/20 p-3 rounded-lg flex items-start gap-3 mt-4 text-emerald-400 text-sm">
            ...
            <p>Intelligence Pipeline, Real-time Monitoring, and Deep Tracking statuses will bind immediately to this Node.</p>
          </div>
        </div>
        ...
        <div className="p-5 border-t border-slate-800 bg-[#0b1325] flex justify-end gap-3">
          ...
          >
            {mutation.isPending ? "Connecting..." : <><Plus className="w-4 h-4" /> Link Node</>}
          </button>
        </div>
      </div>
    </div>
