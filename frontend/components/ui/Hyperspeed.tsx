...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      constructor(container: HTMLElement, options: any = {}) {
        ...
        this.renderer.setPixelRatio(Math.min(1.2, window.devicePixelRatio));
      ...
      onWindowResize() {
        // Use clientWidth/clientHeight instead of offsetWidth/offsetHeight or skip to next frame
        // to avoid synchronous layout thrashing during resize/scroll (especially mobile address bar hide)
      ...
      tick() {
        ...
        if (!this.hasValidSize && this.container) {
  ...
  return <div id="hyperspeed-lights" ref={hyperspeed} style={{ width: '100%', height: '100%', willChange: 'transform' }}></div>;
};
