    ...
    try {
        ...
        let htmlContent = `
            <div style="font-family: monospace; background: #0f172a; color: #22d3ee; padding: 20px; border-radius: 10px; max-width: 600px; margin: 0 auto; border: 1px solid #1e293b;">
                <h1 style="color: #f43f5e; margin-bottom: 0;">🚨 LAMINAR THREAT DETECTED</h1>
                ...
                <table style="width: 100%; color: #cbd5e1; font-size: 14px;">
                    ...
                    <tr><td style="padding: 5px 0;"><strong>SEVERITY:</strong></td><td><span style="color: #f43f5e; font-weight: bold;">${body.severity} (INDEX: 91)</span></td></tr>
                    <tr><td style="padding: 5px 0;"><strong>AI CONFIDENCE:</strong></td><td>${body.confidence}%</td></tr>
                    <tr><td style="padding: 5px 0;"><strong>RISE RATE:</strong></td><td>${body.riseRate} m/min</td></tr>
                    <tr><td style="padding: 5px 0;"><strong>STATUS:</strong></td><td>ROUTE CLOSURE INITIATED - TRAFFIC SIGNALS LOCKED RED</td></tr>
                </table>

                <div style="margin-top: 20px;">
                    <strong style="color: #94a3b8;">EVIDENCE CAPTURED:</strong><br/>
                    <img src="cid:evidence_screenshot" style="width: 100%; border-radius: 8px; margin-top: 10px; border: 2px solid #334155;" alt="Flood Evidence"/>
                </div>
        ...
        let info = await transporter.sendMail({
            ...
            subject: `🚨 URGENT: Route Closure Initiated at ${body.location}`, // Subject line
        ...
        // Only Ethereal has a preview URL, real SMTP does not
