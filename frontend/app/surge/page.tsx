      ...
      <div className="relative z-10 px-6 pt-8 max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-4 glass-panel border-rose-500/20 px-4 py-2 rounded-xl group relative overflow-hidden">
                ...
                <div className="pl-2 pr-1">
                    ...
                    <div className="relative group/select">
                        ...
                        >
                            <option value="" className="bg-black text-white">GLOBAL.MATRIX</option>
            ...
            <div className="glass-panel border-rose-500/20 rounded-3xl p-6 lg:p-8 shadow-[inset_0_0_30px_rgba(244,63,94,0.02)] relative overflow-hidden group">
               ...
               <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                  <div className="flex items-center gap-6 w-full md:w-auto">
                      ...
                      <div>
                          <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">Grid Status Base</h2>
                          <div className="flex items-center gap-3">
                              <div className={`px-4 py-1.5 rounded-lg border text-sm font-black font-mono tracking-widest ${totalActiveSurges > 0 ? "bg-rose-500/20 text-white shadow-[0_0_15px_rgba(244,63,94,0.3)] border-rose-500/50" : "bg-emerald-500/10 text-emerald-400 border-emerald-500/30"}`}>
                                  {totalActiveSurges > 0 ? `CRITICAL [${totalActiveSurges} VECTORS]` : "NOMINAL"}
                              </div>
                  ...
                  <div className="w-full md:w-1/2 bg-black/40 p-5 rounded-2xl border border-white/5 space-y-2 relative overflow-hidden shadow-inner">
                      ...
                      <p className="text-[11px] text-slate-400 leading-relaxed font-mono uppercase tracking-widest">
                          <span className="text-white font-bold opacity-30 select-none mr-2">{'>'}</span> Neural flow matrix monitoring dense centroids.<br/>
                          <span className="text-white font-bold opacity-30 select-none mr-2">{'>'}</span> High-velocity divergence triggers surge protocols.<br/>
                          <span className="text-white font-bold opacity-30 select-none mr-2">{'>'}</span> <span className="text-rose-400 font-bold">Real-time alerts broadcast to all security nodes.</span>
                      </p>
                  </div>
               </div>
            </div>
               ...
               <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10 w-full">
                  <div className="flex-1 space-y-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Deployment Protocol</h2>
                    </div>
                    <div>
                        <div className="flex items-center gap-3 mb-1">
                            <span className="text-2xl font-black text-white tracking-widest">STAFF_REQ:</span>
                            <span className="text-3xl font-black text-sky-400 drop-shadow-[0_0_10px_rgba(14,165,233,0.4)]">
                                {totalActiveSurges > 0 ? (totalActiveSurges * 2 + 3) : "STANDBY"}
                            </span>
                        </div>
                        <p className="text-[10px] text-slate-400 font-mono uppercase tracking-widest flex items-center gap-2">
                            <CheckCircle2 className="w-3 h-3 text-emerald-500" /> 
                            Optimizing for current flow density
                        </p>
                    </div>
                    ...
                    <div className="pt-4 border-t border-white/5 space-y-3">
                        ...
                        <div className="flex gap-2">
                            <div className="flex-1 flex flex-col gap-1">
                                ...
                                <span className="text-[7px] font-black text-white uppercase tracking-tighter">NOW: Deploy</span>
                            </div>
                            <div className="flex-1 flex flex-col gap-1 opacity-40">
                                <div className="h-1 bg-white/10 rounded-full" />
                                <span className="text-[7px] font-bold text-slate-500 uppercase tracking-tighter">T+2M: Pivot</span>
                            </div>
                            <div className="flex-1 flex flex-col gap-1 opacity-20">
                                <div className="h-1 bg-white/10 rounded-full" />
                                <span className="text-[7px] font-bold text-slate-500 uppercase tracking-tighter">T+5M: Secure</span>
                            </div>
                        </div>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-rose-500/20 pb-4">
                ...
                <Zap className="w-5 h-5 text-rose-500" /> Active Surge Vectors
                </h3>
            </div>
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                    <div className="w-full h-32 flex items-center justify-between px-8 border border-emerald-500/30 rounded-3xl glass-panel relative overflow-hidden group shadow-[inset_0_0_20px_rgba(16,185,129,0.05)]">
                        ...
                        <div className="flex items-center gap-6 relative z-10">
                            ...
                            <div>
                                <h4 className="text-emerald-400 font-black uppercase tracking-widest mb-1 text-lg drop-shadow-md">Zero Abnormal Velocity Detected</h4>
                                <p className="text-[10px] text-emerald-500/80 font-mono tracking-widest uppercase font-bold">Continuous optical flow monitoring is active across all configured matrices.</p>
                            </div>
                        </div>
                        <div className="text-right relative z-10 glass-card px-4 py-2 border-emerald-500/20">
                            <div className="text-[9px] text-slate-500 uppercase tracking-[0.2em] font-black mb-1">Optical Flow Baseline</div>
                            <div className="text-2xl font-mono text-emerald-400 font-bold drop-shadow-sm">LIVE</div>
                        </div>
                    </div>
                </motion.div>
            ) : (
                            ...
                            <div className="relative z-10 p-6 flex flex-col h-full">
                                <div className="flex flex-col mb-4">
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <span className="text-[9px] text-slate-500 font-mono font-bold tracking-widest uppercase bg-white/5 border border-white/5 px-2 py-1 rounded-lg">
                                            V_TRACK: <span className="text-white">{alert.id.substring(0, 8)}</span>
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        ...
                                        <span className="text-[10px] text-rose-400 font-mono uppercase font-bold tracking-widest">
                                            Recorded <span className="text-white ml-1">{new Date(alert.created_at).toLocaleTimeString('en-US', { hour12: false })}</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 bg-black/60 border border-white/5 rounded-xl relative overflow-hidden group-hover:border-rose-500/30 transition-all shadow-inner mt-auto">
                                    ...
                                    <p className="text-[11px] text-slate-400 font-mono leading-relaxed pl-2 line-clamp-2">
                                        <span className="text-rose-400 font-bold opacity-80 mr-1">ACTION:</span>{alert.extra_data?.recommended_action || "Divergent crowd flow detected. Neural models suggest immediate tactical intervention."}
                                    </p>
                                </div>
                                ...
                                <div className="mt-5 flex items-center justify-between border-t border-white/10 pt-4 relative z-10">
                                    <div className="flex items-center gap-3 bg-white/5 px-4 py-2 rounded-xl border border-white/5 group-hover:bg-rose-500/5 group-hover:border-rose-500/20 transition-colors">
                                        ...
                                        <span className="text-[10px] font-mono font-black text-rose-400 uppercase tracking-widest">INDEX: <span className="text-white text-sm tracking-normal ml-1">{alert.severity}</span></span>
                                    </div>
                                    <motion.button 
                                    ...
                                    >
                                        ENGAGE <ChevronRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
                                    </motion.button>
                                </div>
                            </div>
                        </motion.div>
                ...
                <AnimatePresence mode="popLayout">
                    {Object.entries(cameraMetrics).length > 0 ? (
                        ...
                        >
                            ...
                            <h4 className="text-sm font-black uppercase tracking-[0.2em] mb-2 text-white">Awaiting Sensor Matrix</h4>
                            <p className="text-xs font-mono opacity-50 text-slate-400">No live camera metrics detected for the selected zone.</p>
                        </motion.div>
                    )}
                </AnimatePresence>
            </div>
