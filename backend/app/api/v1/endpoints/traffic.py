...
async def stream_traffic_camera(camera_id: str):
    ...
    def _create_standby_frame():
        ...
        cv2.putText(frame, f"EDGE NODE // {camera_id[:8]}", (20, 35), cv2.FONT_HERSHEY_SIMPLEX, 0.55, (100, 100, 255), 2)
        cv2.putText(frame, "CAMERA OFFLINE - SOURCE UNAVAILABLE", (20, 65), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (80, 80, 220), 1)
        cv2.putText(frame, "No live video feed received from sensor source.", (20, 95), cv2.FONT_HERSHEY_SIMPLEX, 0.38, (120, 120, 140), 1)
